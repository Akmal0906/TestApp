...
///
/// Used by [MyDropdownMenu.searchCallback].
...
const double _kMinimumWidth = 100.0;

const double _kDefaultHorizontalPadding = 6.0;
...
class MyDropdownMenu<T> extends StatefulWidget {
  ...
  /// by the width of menu items or [MyDropdownMenu.width]. If this property is not null,
  ...
  /// When  [MyDropdownMenu.enableSearch] is true, this callback is used to compute
  ...
  /// {@end-tool}
  ///
  /// Defaults to null. If this is null and [MyDropdownMenu.enableSearch] is true,
...
class _MyDropdownMenuState<T> extends State<MyDropdownMenu<T>> {
  ...
  List<Widget> _buildButtons(
      List<MyDropdownMenuEntry<T>> filteredEntries, TextDirection textDirection,
  ...
  Widget build(BuildContext context) {
    ...
    Widget menuAnchor = MenuAnchor(
      ...
      builder:
        ...
        final Widget trailingButton = InkWell(
