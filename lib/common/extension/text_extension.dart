...
extension TextStringExtensions on String {
  ...
  Text text({TextAlign? textAlign, int? maxLines}) =>
      Text(this, textAlign: textAlign, maxLines: maxLines);
}
...
extension TextExtensions on Text {
  ...
  Text s(double size) =>
      copyWith(style: (style ?? TextStyle()).copyWith(fontSize: size));

  Text c(Color color) =>
      copyWith(style: (style ?? const TextStyle()).copyWith(color: color));

  Text a(TextAlign textAlign) =>
      copyWith(style: (style ?? const TextStyle()), textAlign: textAlign);
